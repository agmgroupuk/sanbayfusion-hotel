...
export const membershipApplicationSchema = z.object({
  ...
  confirmsInformation: z.literal(true, { error: "Please confirm your information is correct" }),
  reviewedMembership: z.literal(true, { error: "Please confirm you reviewed your membership" }),
  understandsRequest: z.literal(true, { error: "Please confirm this is a request, not activation" }),
  understandsInvoiceWindow: z.literal(true, { error: "Please confirm the three-day invoice window" }),
  understandsNonRefundable: z.literal(true, { error: "Please confirm the non-refundable membership rule" }),
  understandsPackageLock: z.literal(true, { error: "Please confirm the package lock rule" }),
  understandsDeliveryNotice: z.literal(true, { error: "Please confirm the three-day delivery notice" }),
  agreesTerms: z.literal(true, { error: "Please agree to the Membership Terms & Conditions" }),
  acknowledgesPrivacy: z.literal(true, { error: "Please acknowledge the Privacy Policy" }),
  agreesContact: z.literal(true, { error: "Please agree to be contacted" }),
